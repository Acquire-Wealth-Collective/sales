...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-v8gQTaE6.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Cxl4vns6.js").then((n) => n.r),
    import("./start-Dy6uH6n8.js"),
...
var ROUTER_BASEPATH = "sales";
var SERVER_FN_BASE = "/sales/_serverFn/";
